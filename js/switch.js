...
let contBtns = document.querySelector(".cont-btns");
...
let a2 = document.querySelector("footer .a2");
...
[...input].forEach((e,i) => {
    e.addEventListener("click", () => {
        if (i === 0) {
            ...
            footer.style.color = "#ffe53d";
            a.style.color = "#ffe53d";
            a2.style.color = "#ffe53d";
        }
    });
});